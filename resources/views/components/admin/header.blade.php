<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <!--end::Brand-->
    <!--begin::Toolbar-->
    <div class="toolbar d-flex align-items-stretch " style="background-color: #1363C6;color:white">
        ...
        <div
            ...
            <div class="page-title d-flex justify-content-center flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-white fw-bolder fs-3 mb-0">{{ $pageTitle ?? 'Dashboard' }}</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
        </div>
